...
def resource_path(relative_path):
    """ Dapatkan path absolut untuk resource, bekerja baik untuk dev dan setelah di-build menjadi exe. """
...
class BetonCalculatorApp:
    ...
    def setup_ui(self):
        ...
        try:
            # Load logo image
            logo_image_path = resource_path("images/logo.jpg")
            with Image.open(logo_image_path) as logo_image:
